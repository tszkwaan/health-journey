...
interface ParamMap {
  ...
  "/api/test/create-time-slot": {}
  "/api/test/doctors/[id]": { "id": string; }
  "/api/test/enhanced-summary": {}
  "/api/test/enhanced-summary-real": {}
