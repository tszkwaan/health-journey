...
async function NextAuthApiHandler(req, res, options) {
    ...
    (_options$secret = options.secret) !== null && _options$secret !== void 0 ? _options$secret : options.secret = (_ref = (_options$jwt$secret = (_options$jwt = options.jwt) === null || _options$jwt === void 0 ? void 0 : _options$jwt.secret) !== null && _options$jwt$secret !== void 0 ? _options$jwt$secret : ("TURBOPACK compile-time value", "7741f47585fdb33ad95d58c794f693044c2b0aa4c00589972ad95bd6cb170f31")) !== null && _ref !== void 0 ? _ref : process.env.AUTH_SECRET;
...
async function NextAuthRouteHandler(req, context, options) {
    ...
    (_options$secret2 = options.secret) !== null && _options$secret2 !== void 0 ? _options$secret2 : options.secret = (_process$env$NEXTAUTH = ("TURBOPACK compile-time value", "7741f47585fdb33ad95d58c794f693044c2b0aa4c00589972ad95bd6cb170f31")) !== null && _process$env$NEXTAUTH !== void 0 ? _process$env$NEXTAUTH : process.env.AUTH_SECRET;
...
async function getServerSession(...args) {
    ...
    (_options$secret3 = (_options = options).secret) !== null && _options$secret3 !== void 0 ? _options$secret3 : _options.secret = (_process$env$NEXTAUTH2 = ("TURBOPACK compile-time value", "7741f47585fdb33ad95d58c794f693044c2b0aa4c00589972ad95bd6cb170f31")) !== null && _process$env$NEXTAUTH2 !== void 0 ? _process$env$NEXTAUTH2 : process.env.AUTH_SECRET;
...
//# sourceMappingURL=node_modules_next-auth_1810886e._.js.map